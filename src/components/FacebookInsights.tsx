  ...
  return (
    <>
      <motion.section
        ...
        <p className="text-sm text-muted-foreground mb-4">AI-powered Facebook post ideas and live trending topics for the funeral profession. Get engagement tips and turn ideas into scripts.</p>
